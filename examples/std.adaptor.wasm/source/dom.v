...
micro dom_get_by_id(id: utf16): i32

[js_builtin("document.querySelector")]
micro dom_query(selector: utf16): i32

[js_builtin("document.querySelectorAll")]
micro dom_query_all(selector: utf16): i32
...
micro dom_create_element(tag: utf16): i32

[js_builtin("document.createTextNode")]
micro dom_create_text(text: utf16): i32
...
micro dom_set_attr(handle: i32, name: utf16, value: utf16)

[js_builtin("Element.getAttribute")]
micro dom_get_attr(handle: i32, name: utf16): utf16

[js_builtin("Element.removeAttribute")]
micro dom_remove_attr(handle: i32, name: utf16)

[js_builtin("Element.textContent")]
micro dom_set_text(handle: i32, text: utf16)

[js_builtin("Element.innerHTML")]
micro dom_set_inner_html(handle: i32, html: utf16)
...
micro dom_set_style(handle: i32, prop: utf16, value: utf16)

[js_builtin("Element.classList.add")]
micro dom_class_add(handle: i32, token: utf16)

[js_builtin("Element.classList.remove")]
micro dom_class_remove(handle: i32, token: utf16)

[js_builtin("Element.classList.toggle")]
micro dom_class_toggle(handle: i32, token: utf16)
...
micro dom_add_event(handle: i32, event: utf16, callback: i32)

[js_builtin("Element.removeEventListener")]
micro dom_remove_event(handle: i32, event: utf16, callback: i32)
